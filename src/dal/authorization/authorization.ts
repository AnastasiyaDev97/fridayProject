...
export const authorizationAPI = {
  registerMe(email: string, password: string) {
    return instance
      .post<RegisterErrorResponse>(`auth/register`, { email, password })
      .then((res) => {
        return res.data;
      });
  },
  loginMe(loginAuthData: loginAuthDataType) {
    return instance
      .post<ResponseLoginType>(`auth/login`, loginAuthData)
      .then((res) => {
        return res.data;
      });
  },
  logoutMe() {
    return instance.delete<LogoutResponse>(`auth/me`).then((res) => {
      return res.data;
    });
  },
  authMe() {
    return instance.post<ResponseLoginType>(`auth/me`).then((res) => {
      return res.data;
    });
  },
...
link</a></div>`,
    ...
    return instance
      .post<ResponseForgotPasswordType>(`auth/forgot`, messageDataPassword)
      .then((res) => {
        return res.data;
      });
  },
  setNewPassword(newPassData: newPassDataType) {
    return instance
      .post<LogoutResponse>(`auth/set-new-password`, newPassData)
      .then((res) => {
        return res.data;
      });
  },
